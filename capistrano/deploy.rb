...
set :app_webroot, 'services/drupal/public'
set :webroot, 'public'

set :linked_dirs, ["services/drupal/public/sites/default/files"]
set :linked_files, ["services/drupal/.env"]
